...
@section('title','List Receiver | MyBlood')
@section('body')
@push('css')
<!-- Datatables -->
...
<div class="modal fade" id="view_" tabindex="-1" role="dialog" aria-labelledby="MetatypeModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <h5 class="modal-title text-light" id="MetaTypeModaleditLongTitle"><small>Receiver Details</small></h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="Input1">Last blood Donor name :-</label>
                            <input type="text" value="" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="Input1">Last blood donation date :-</label>
                            <input type="text" value="" class="form-control" readonly>
                        </div>
                    </div>
                </div>
